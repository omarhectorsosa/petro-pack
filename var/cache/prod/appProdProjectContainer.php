...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QfsGKk79j1', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hZqlurzwi5', 0, 'Iy6xBO-GsbSIKUnKbDoB+K', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'petropack_prod', 'user' => 'root', 'password' => NULL, 'charset' => 'utf8mb4', 'driverOptions' => array(), 'defaultTableOptions' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci')), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\PetroPack\\ProductoBundle\\Resources\\config\\doctrine') => 'PetroPack\\ProductoBundle\\Entity', ($this->targetDirs[3].'\\src\\PetroPack\\ClienteBundle\\Resources\\config\\doctrine') => 'PetroPack\\ClienteBundle\\Entity', ($this->targetDirs[3].'\\src\\PetroPack\\VentaBundle\\Resources\\config\\doctrine') => 'PetroPack\\VentaBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'PetroPack\\ProductoBundle\\Entity');
        $b->addDriver($a, 'PetroPack\\ClienteBundle\\Entity');
        $b->addDriver($a, 'PetroPack\\VentaBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('PetroPackProductoBundle' => 'PetroPack\\ProductoBundle\\Entity', 'PetroPackClienteBundle' => 'PetroPack\\ClienteBundle\\Entity', 'PetroPackVentaBundle' => 'PetroPack\\VentaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_342a87bde7cdb5889a2d68bc6f95dca87c44fe66b1e7d2cc1f198e7c712497d4');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('-TtGAXd4oP', NULL, 'Iy6xBO-GsbSIKUnKbDoB+K', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(${($_ = isset($this->services['security.firewall.map']) ? $this->services['security.firewall.map'] : $this->getSecurity_Firewall_MapService()) && false ?: '_'}, $this->get('event_dispatcher'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'cache' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPack\\ProductoBundle/Resources/views'), 'PetroPackProducto');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPack\\LoginBundle/Resources/views'), 'PetroPackLogin');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPack\\ClienteBundle/Resources/views'), 'PetroPackCliente');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPack\\VentaBundle/Resources/views'), 'PetroPackVenta');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPack\\MenuBundle/Resources/views'), 'PetroPackMenu');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPackFront\\LoginBundle/Resources/views'), 'PetroPackFrontLogin');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPackFront\\MenuBundle/Resources/views'), 'PetroPackFrontMenu');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPackFront\\ProductoBundle/Resources/views'), 'PetroPackFrontProducto');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPackFront\\PaginadoBundle/Resources/views'), 'PetroPackFrontPaginado');
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPack\\PaginadoBundle/Resources/views'), 'PetroPackPaginado');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('28060033fa8e40afd47be71d4a4b3d9038709315');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RysDo8gSV5', 0, 'Iy6xBO-GsbSIKUnKbDoB+K', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nq+FPb8+VQ', 0, 'Iy6xBO-GsbSIKUnKbDoB+K', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PetroPackProductoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPack\\ProductoBundle'),
                    'namespace' => 'PetroPack\\ProductoBundle',
                ),
                'PetroPackLoginBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPack\\LoginBundle'),
                    'namespace' => 'PetroPack\\LoginBundle',
                ),
                'PetroPackClienteBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPack\\ClienteBundle'),
                    'namespace' => 'PetroPack\\ClienteBundle',
                ),
                'PetroPackVentaBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPack\\VentaBundle'),
                    'namespace' => 'PetroPack\\VentaBundle',
                ),
                'PetroPackMenuBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPack\\MenuBundle'),
                    'namespace' => 'PetroPack\\MenuBundle',
                ),
                'PetroPackFrontLoginBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPackFront\\LoginBundle'),
                    'namespace' => 'PetroPackFront\\LoginBundle',
                ),
                'PetroPackFrontMenuBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPackFront\\MenuBundle'),
                    'namespace' => 'PetroPackFront\\MenuBundle',
                ),
                'PetroPackFrontProductoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPackFront\\ProductoBundle'),
                    'namespace' => 'PetroPackFront\\ProductoBundle',
                ),
                'PetroPackFrontPaginadoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPackFront\\PaginadoBundle'),
                    'namespace' => 'PetroPackFront\\PaginadoBundle',
                ),
                'PetroPackPaginadoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPack\\PaginadoBundle'),
                    'namespace' => 'PetroPack\\PaginadoBundle',
                ),
            ); break;
            case 'path_img': $value = ($this->targetDirs[3].'\\web\\backend\\img\\upload\\'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PetroPackProductoBundle' => 'PetroPack\\ProductoBundle\\PetroPackProductoBundle',
                'PetroPackLoginBundle' => 'PetroPack\\LoginBundle\\PetroPackLoginBundle',
                'PetroPackClienteBundle' => 'PetroPack\\ClienteBundle\\PetroPackClienteBundle',
                'PetroPackVentaBundle' => 'PetroPack\\VentaBundle\\PetroPackVentaBundle',
                'PetroPackMenuBundle' => 'PetroPack\\MenuBundle\\PetroPackMenuBundle',
                'PetroPackFrontLoginBundle' => 'PetroPackFront\\LoginBundle\\PetroPackFrontLoginBundle',
                'PetroPackFrontMenuBundle' => 'PetroPackFront\\MenuBundle\\PetroPackFrontMenuBundle',
                'PetroPackFrontProductoBundle' => 'PetroPackFront\\ProductoBundle\\PetroPackFrontProductoBundle',
                'PetroPackFrontPaginadoBundle' => 'PetroPackFront\\PaginadoBundle\\PetroPackFrontPaginadoBundle',
                'PetroPackPaginadoBundle' => 'PetroPack\\PaginadoBundle\\PetroPackPaginadoBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'petropack_prod',
            'database_user' => 'root',
            ...
            'secret' => '28060033fa8e40afd47be71d4a4b3d9038709315',
            'url_img' => 'http://localhost:8080/backend/img/upload/',
            'cant_items_pagina' => 10,
            'grupo_pagina' => 5,
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '28060033fa8e40afd47be71d4a4b3d9038709315',
