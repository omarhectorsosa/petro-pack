...
namespace Proxies\__CG__\PetroPack\ClienteBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Cliente extends \PetroPack\ClienteBundle\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PetroPack\\ClienteBundle\\Entity\\Cliente' . "\0" . 'id', '' . "\0" . 'PetroPack\\ClienteBundle\\Entity\\Cliente' . "\0" . 'nombre', '' . "\0" . 'PetroPack\\ClienteBundle\\Entity\\Cliente' . "\0" . 'direccion', '' . "\0" . 'PetroPack\\ClienteBundle\\Entity\\Cliente' . "\0" . 'email', '' . "\0" . 'PetroPack\\ClienteBundle\\Entity\\Cliente' . "\0" . 'dni'];
        }
