...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NfEN5QaxUW', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NmKOoV3NTO', 0, 'n31+EoPiy8TAubgSkBZfFt', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\PetroPack\\CustomerBundle\\Entity'))), 'PetroPack\\CustomerBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('PetroPackCustomerBundle' => 'PetroPack\\CustomerBundle\\Entity', 'PetroPackProductoBundle' => 'PetroPack\\ProductoBundle\\Entity', 'PetroPackClienteBundle' => 'PetroPack\\ClienteBundle\\Entity', 'PetroPackVentaBundle' => 'PetroPack\\VentaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e205c1aeaf2857a094ab3a0c0cf0c7b0a9990ed49971144ea4992721c352f5f4');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PetroPack\\CustomerBundle/Resources/views'), 'PetroPackCustomer');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fm1Vlcq3lQ', 0, 'n31+EoPiy8TAubgSkBZfFt', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PetroPackCustomerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PetroPack\\CustomerBundle'),
                    'namespace' => 'PetroPack\\CustomerBundle',
                ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PetroPackCustomerBundle' => 'PetroPack\\CustomerBundle\\PetroPackCustomerBundle',
